...
@section('container')
    @canany(['isAdmin', 'isMarketing', 'isAccounting', 'isOwner', 'isMedia'])
        <div class="index-container mt-8 z-0 sm:w-full md:w-full lg:w-full">
            ...
            <div class="flex p-2 w-[540px] sm:w-[640px] md:w-[768px] lg:w-full xl:w-full mt-8 overflow-x-auto">
                <form action="/dashboard/media/billboards/">
                    <div class="w-32 flex absolute mt-4">
                        <span class="w-24 flex absolute text-base text-teal-900">Area</span>
                        <input type="text" id="requestArea" name="requestArea" value="{{ request('area') }}" hidden>
                        <select class="w-32 border rounded-lg flex absolute text-base text-teal-900 outline-none" name="area"
                    ...
                    <div class="w-32 flex absolute ml-[135px] mt-4">
                        ...
                        <select class="w-32 border rounded-lg flex absolute text-base text-teal-900 outline-none"
                            name="requestCity" id="requestCity" onchange="submit()">
                            <option value="All">All</option>
                        </select>
                    </div>
                    <div class="w-32 flex absolute ml-[270px] mt-4">
                        <span class="w-32 flex absolute text-base text-teal-900">Kondisi</span>
                        <select class="w-32 border rounded-lg flex absolute text-base text-teal-900 outline-none" name="build"
                    ...
                    <div class="w-32 flex absolute ml-[405px] mt-4">
                        <span class="w-32 flex absolute text-base text-teal-900">Status</span>
                        <select class="w-32 border rounded-lg flex absolute text-base text-teal-900 outline-none" name="sale"
                ...
                <table class="table-auto mt-14">
                    <thead>
                        <tr class="index-tr bg-slate-50 border-t">
                            <th class="index-td text-sm w-5 ml-2">No.</th>
                            ...
                            @if ($product->category == 'Billboard')
                                @if ($loop->iteration % 2 != 0)
                                    <tr class="index-tr">
                                        ...
                                        <td class="index-td text-sm w-24">{{ $product->code }} -
                                            {{ $product->city->code }}
                                        </td>
                                        <td class="flex justify-start items-center text-sm w-60">{{ $product->address }}
                                        </td>
                                        ...
                                        @else
                                            <td class="index-td text-sm w-28">-</td>
                                        @endif

                                        @if ($product->price)
                                            <td class="flex items-center justify-end text-sm w-24">
                                                {{ number_format($product->price) }}</td>
                                        @else
                                            <td class="index-td text-sm w-24">-</td>
                                        @endif
                                        @if ($product->start_contract)
                                            <td class="index-td text-sm w-28">
                                ...
                                @else
                                    <tr class="index-tr bg-slate-50 bg-opacity-50">
                                        <td class="index-td text-sm w-5 text-center">{{ $loop->iteration }}</td>
                                        <td class="index-td text-sm w-24">{{ $product->code }} -
                                            {{ $product->city->code }}
                                        </td>
